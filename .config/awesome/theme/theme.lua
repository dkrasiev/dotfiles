...
local colors                                    = {
    ...
    -- bg_secondary0 = palette.crust.hex,
    -- bg_secondary1 = palette.mantle.hex,
    -- bg_surface0   = palette.surface0.hex,
    -- bg_surface1   = palette.surface1.hex,
    -- bg_surface2   = palette.surface2.hex,
    -- bg_overlay0   = palette.overlay0.hex,
    -- bg_overlay1   = palette.overlay1.hex,
    -- bg_overlay2   = palette.overlay2.hex,
}
